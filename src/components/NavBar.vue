        ...
        <div class="navbar-row">
          <div>
            <nav role="navigation" class="nav-menu w-nav-menu">
              ...
              <div>
                <a href="https://discord.gg/rbquJjMzau" target="_blank" class="link-block-3 social-link-item w-inline-block"><img src="images/discord_logo.png" loading="lazy" width="55" height="55" alt="" class="image-5"></a>
              </div>
            </nav>
          </div>
